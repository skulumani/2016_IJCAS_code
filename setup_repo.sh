...
git_repo="git@github.com:skulumani/2016_IJCAS_code.git"
bb_repo="git@bitbucket.org:shankarkulumani/2016_ijcas_code.git"
fdcl_repo="git@github.com:fdcl-gwu/2016_IJCAS_code.git"
